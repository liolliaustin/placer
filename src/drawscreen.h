...
class Graphics{
public:
   //Graphics(Objects &nets): net(nets){this-> net = net;}
...
void Graphics::act_on_new_button_func (void (*drawscreen_ptr) (void)) {
...
void Graphics::act_on_button_press (float x, float y) {
...
void Graphics::act_on_mouse_move (float x, float y) {
...
void Graphics::act_on_key_press (char c) {
